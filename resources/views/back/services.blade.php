                                            ...
                                            <div class="card-header border-0">
                                                <div class="row g-4">
                                                    <div class="col-sm-auto">
                                                        <div>
                                                            <a href="{{url('/addservice')}}" class="btn btn-success" id="addproduct-btn"><i class="ri-add-line align-bottom me-1"></i> Add Service</a>
                                                        </div>
                                                    </div>
                                                    <!--
                                                    <div class="col-sm">
                                                        ...
                                                        <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#productnav-all" role="tab" aria-selected="true">
                                                                    All <span class="badge badge-soft-danger align-middle rounded-pill ms-1">{{count($services)}}</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                                    ...
                                                                    <table role="grid" class="gridjs-table" style="height: auto;">
                                                                        <thead class="gridjs-thead">
                                                                            <tr class="gridjs-tr">
                                                                                ...
                                                                                <th data-column-id="product" class="gridjs-th gridjs-th-sort text-muted" tabindex="0" style="width: 360px;">
                                                                                    <div class="gridjs-th-content">Sub Title</div>
                                                                                </th>
                                                                            ...
                                                                            @if(isset($services) && count($services))
                                                                                ...
                                                                                @foreach($services as $content)
                                                                                    ...
                                                                                    <tr class="gridjs-tr">
                                                                                        ...
                                                                                        <td class="gridjs-td">{{$content->subtitle}} </td>
                                                                                            ...
                                                                                            <span>
                                                                                                <div class="dropdown">
                                                                                                    ...
                                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                                        <li>
                                                                                                            <a class="dropdown-item edit-list"  href="{{url('/addservice', Illuminate\Support\Facades\Crypt::encrypt($content->id))}}">
                                                                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit
                                                                                                            </a>
                                                                                                        </li>
                                                                                                        
                                                                                                        <li>
                                                                                                            <a class="dropdown-item edit-list"  href="{{url('/deleteservice', Illuminate\Support\Facades\Crypt::encrypt($content->id))}}"   onclick="return confirm(' Are you sure you want to delete this service?');">
